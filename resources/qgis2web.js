...
map.getView().fit([-13223405.843504, 3970517.051374, -13059580.475863, 4058265.753381], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Operations Districts</h2>';
        return titleElement;
    })(),
