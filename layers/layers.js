...
lyr_OpenStreetMap_0.setVisible(true);lyr_SouthRegionCafes_1.setVisible(true);lyr_NorthRegionCafes_2.setVisible(true);lyr_FranchiseCafes_3.setVisible(true);
var layersList = [lyr_OpenStreetMap_0,lyr_SouthRegionCafes_1,lyr_NorthRegionCafes_2,lyr_FranchiseCafes_3];
...
lyr_FranchiseCafes_3.on('precompose', function(evt) {
